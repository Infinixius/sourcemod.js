...
export type RenderEffect = typeof RenderEffect[keyof typeof RenderEffect]
/**
 ...
 */
export function randArray(array: Array<any>) {
 ...
 */
 export function checkBytes(str: string, max: number) {
